    ...
    "texts": [
      {
        ...
        "title": "Self-Reliance",
        "description": "An essay that contains the most thorough statement of one of Emerson's recurrent themes: the need for each individual to avoid conformity and false consistency, and follow their own instincts and ideas.",
        "published": 1841
      },
      {
        "id": "nature",
        "writerId": "ralph-waldo-emerson",
        "title": "Nature",
        "description": "An essay that puts forth the foundation of transcendentalism, a belief system that espouses a non-traditional appreciation of nature.",
        "published": 1836
      },
      {
